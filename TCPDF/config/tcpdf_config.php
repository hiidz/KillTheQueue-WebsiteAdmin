 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'KillTheQueue');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'KillTheQueue');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Product Page');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "with KillTheQueue");
